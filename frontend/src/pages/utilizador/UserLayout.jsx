...
const navItems = [
  { to: "/utilizador/dashboard", icon: <Home size={18} />, label: "Dashboard" },
  { to: "/utilizador/propostas-compativeis", icon: <FileText size={18} />, label: "Propostas Compatíveis" },
  { to: "/utilizador/favoritos", icon: <Star size={18} />, label: "Favoritos" },
  { to: "/utilizador/perfil", icon: <User size={18} />, label: "Perfil" }
];
      ...
      >
        <div>
          ...
          >
            ...
            <span className="text-sm text-gray-300">Utilizador</span>
          </div>
